...
cnn = CLMA_Net(classes=class_number, HSI_Data_Shape_H=m, HSI_Data_Shape_W=n, HSI_Data_Shape_C=l)
...
print('程序运行total时长：', code_end_time - code_start_time)  # 运行时间，单位是  时:分:秒
print('training 时长：', end_training_time - start_training_time)  # 运行时间，单位是  时:分:秒
print('testing 时长：', end_testing_time - start_testing_time)  # 运行时间，单位是  时:分:秒
